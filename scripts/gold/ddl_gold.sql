...
Usage:
    These view can be queried directly for reporting and analytics.
================================================================================    
*/
...
SELECT
    ...
    pn.product_key, -- Surrogate Key from dimension table
    ci.customer_key, -- Surrogate Key from dimension table
